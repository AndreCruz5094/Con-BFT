...
$Signer sign -key $2 -enclave /home/andrecruz/Tese/Con-BFT/build/install/library/enclave.so -out $signedEnclave -config $configPath
mv $signedEnclave /home/andrecruz/Tese/Con-BFT/build/install/library
